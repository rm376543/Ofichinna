...
namespace Ofichina.Infrastructure.Migrations
{
    ...
    [Migration("20260803203527_007-relacionamentos-motivo-recusa-historico-status")]
    partial class _007relacionamentosmotivorecusahistoricostatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ofichina.Domain.Entities.ItemOrcamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ofichina.Domain.Entities.ItemOrcamentoPeca", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ItemOrcamentoId");

                    b.HasIndex("PecaId");

                    b.ToTable("ItensOrcamentoPecas", (string)null);
                });
            ...
            modelBuilder.Entity("Ofichina.Domain.Entities.ItemOrcamentoPeca", b =>
                {
                    b.HasOne("Ofichina.Domain.Entities.ItemOrcamento", null)
                        .WithMany("Pecas")
                        .HasForeignKey("ItemOrcamentoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
