...
namespace Ofichina.Infrastructure.Migrations
{
    ...
    [Migration("20260717195516_009-item-peca-peca-nav")]
    partial class _009itempecapecanav
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ofichina.Domain.Aggregates.Agendamento", b =>
                {
                    b.HasOne("Ofichina.Domain.Entities.DiaDisponibilidade", null)
                        .WithMany()
                        .HasForeignKey("DiaDisponibilidadeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Ofichina.Domain.Entities.HorarioConsultor", null)
                        .WithMany()
